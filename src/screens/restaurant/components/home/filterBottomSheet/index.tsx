...
import { commitFilters, setCommitFiltersToStaged, setIsFiltersApplied, setShowFilters } from '@/redux/slices/restaurantSlice';
...
const FilterBottomSheet = () => {
    ...
    const { showFilters, appliedFilters, appliedSort, stagedFilters, stagedSort, isFiltersApplied } = useSelector((state: RootState) => state.restaurant);
