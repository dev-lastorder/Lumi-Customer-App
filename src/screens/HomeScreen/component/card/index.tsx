...
const DATA = [
  ...
  { id: "4", title: "LUMI Hotel", type: "video", source: require("@/assets/videos/LumiHotel.mp4"), icon: require("@/assets/images/lumiHotelLogo.png"), size: "small" },
  ...
  { id: "5", title: "LUMI Hotel", type: "video", source: require("@/assets/videos/LumiHotel.mp4"), icon: require("@/assets/images/lumiHotelLogo.png"), size: "large" },
