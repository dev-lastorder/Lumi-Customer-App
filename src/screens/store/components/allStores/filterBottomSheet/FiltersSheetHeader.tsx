...
import { clearFilters, setIsFiltersApplied, setShowFilters } from '@/redux/slices/storeSlice';
...
const FiltersSheetHeader = () => {
    ...
    const { stagedFilters , stagedSort } = useSelector((state : RootState) => state.store)
